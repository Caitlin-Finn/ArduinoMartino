...
import finnsaneproductions.arduinomartino.PrepareDrinkModel;
import finnsaneproductions.arduinomartino.R;
import finnsaneproductions.arduinomartino.StepListAdapter;
...
import finnsaneproductions.arduinomartino.interfaces.Drink;
...
public class PrepareDrink extends Activity {
    ...
    @BindView(R.id.preparedrink_steps)
    public ListView stepListView;

    @BindView(R.id.preparedrink_main)
    public RelativeLayout mainView;

    @BindView(R.id.preparedrink_connecting)
